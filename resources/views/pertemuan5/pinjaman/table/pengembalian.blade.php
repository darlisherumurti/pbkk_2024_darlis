            ...
            @role('admin|petugas')
                <td>
                    <div class="d-flex">
                        ...
                        @if ($p->status_persetujuan === 'Disetujui' && $p->status_pengembalian === 'Belum dikembalikan')
                            <form class="actionForm" action="{{ route('pinjaman.kembalikan', $p->id) }}" method="post">
                                @csrf
                                <button type="submit" class="btn btn-sm mr-2 btn-success">Kembalikan</button>
                            </form>
                        @endif
                    </div>
                </td>
