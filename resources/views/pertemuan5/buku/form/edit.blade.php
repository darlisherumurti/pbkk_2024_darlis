...
<form id="updateForm" action="{{ route('buku.update', $buku->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control @error('image_url') is-invalid @enderror" id="image_url"
                        name="image_url" value="{{ old('image_url', $buku->image_url) }}" required>
        ...
        <div class="col-md-6">
            ...
            <div id="imagePreviewContainer" class="border p-2" style="min-height: 200px;">
                <a href="{{ $buku->image_url }}" data-lightbox="book-image" data-title="{{ $buku->judul }}">
                    <img loading="lazy" id="imagePreview" src="{{ old('image_url', $buku->image_url) }}" alt="No image"
    ...
    @include('pertemuan5.buku.form.hapus', ['buku' => $buku])
</form>
@push('scripts')
